...
public class EditorReactions {
    ...
    public static final RbEditorHideMoneyPanel rbEditorHideMoneyPanel = new RbEditorHideMoneyPanel();
    ...
    public static final RbEditorShowMoneyPanel rbEditorShowMoneyPanel = new RbEditorShowMoneyPanel();
